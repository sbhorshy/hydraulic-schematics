...
| 24 | USR-001 | extern:outlet | 清单18 用户(未建模为组件) | 边界标记 (1518,400) | — |
| 25 | USR-002 | extern:return | 清单18 用户(未建模为组件) | 边界标记 (1518,700) | — |
...
| 53 | `EDP-001.pressure_out -> @PRESS` | (618,330)->(918,0) | pressure | 1 |
| 54 | `EMP-001.pressure_out -> @PRESS` | (618,650)->(918,0) | pressure | 1 |
| 55 | `@PRESS -> PF-001` | (918,0)->(1038,358) | pressure | 1 |
| 55 | `PF-001 -> @MANIFOLD` | (1118,358)->(1198,0) | pressure | 1 |
| 59 | `@MANIFOLD -> PRV-001` | (1198,0)->(1338,317) | pressure | 1 |
| 59 | `PRV-001 -> USR-001` | (1478,317)->(1518,400) | pressure | 1 |
| 60 | `@MANIFOLD -> ACC-001.hydraulic_port` | (1198,0)->(1248,290) | pressure | 1 |
| 61 | `@PRESS -> PRV-002` | (918,0)->(578,781) | pressure | 1 |
| 61 | `PRV-002 -> TANK-001.bootstrap_pressure_in` | (438,781)->(232,840) | pressure | 1 |
| 62 | `@MANIFOLD -> QDP-001.inlet` | (1198,0)->(1224,594) | pressure | 1 |
| 65 | `USR-002 -> RF-001` | (1518,700)->(1318,728) | return | 1 |
| 65 | `RF-001 -> @RET` | (1238,728)->(978,0) | return | 1 |
| 66 | `@RET -> TANK-001.return_in` | (978,0)->(60,686) | return | 1 |
| 67 | `@RET -> QDR-001.inlet` | (978,0)->(1238,934) | return | 1 |
...
| intent 行 | 语句 | 图上支路(端点) |
|---|---|---|
| 77 | `{"sensor": "ACV-001.accumulator_gas", "at": "ACC-001.gas_port"}` | (1278,120)->(1248,190) |
| 78 | `{"sensor": "PG-001.pressure_sense", "at": "ACV-001.charge_port"}` | (1517,157)->(1412,120) |
