...
|---|---|---|---|---|
| 55 | `TANK-001.suction_out -> EMP-001.suction` | (338,666)->(538,650) | suction | 1 |
| 56 | `TANK-001.suction_out -> FSOV-001` | (338,666)->(388,330) | suction | 1 |
| 56 | `FSOV-001 -> EDP-001.suction` | (468,330)->(538,330) | suction | 1 |
| 60 | `EDP-001.pressure_out -> @PRESS` | (618,330)->(680,0) | pressure | 1 |
| 61 | `EMP-001.pressure_out -> @PRESS` | (618,650)->(680,0) | pressure | 1 |
| 62 | `@PRESS -> PF-001` | (680,0)->(1000,330) | pressure | 1 |
...
| 75 | `@MANIFOLD -> ACC-001.hydraulic_port` | (1170,0)->(1170,290) | pressure | 1 |
| 76 | `@PRESS -> PRV-002` | (680,0)->(578,791) | pressure | 1 |
| 76 | `PRV-002 -> TANK-001.bootstrap_pressure_in` | (438,791)->(292,820) | pressure | 1 |
| 77 | `@MANIFOLD -> QDP-001.inlet` | (1170,0)->(1188,454) | pressure | 1 |
...
| 90 | `RF-001 -> @RET` | (1200,1040)->(1170,0) | return | 1 |
| 91 | `@RET -> TANK-001.return_in` | (1170,0)->(120,666) | return | 1 |
| 92 | `@RET -> QDR-001.inlet` | (1170,0)->(1200,934) | return | 1 |
...
| 98 | `CDF-001 -> TANK-001.return_in` | (480,160)->(120,666) | case_drain | 1 |

## 气侧支路(taps,规范 11.1)

| intent 行 | 语句 | 图上支路(端点) |
|---|---|---|
| 102 | `{"sensor": "ACV-001.accumulator_gas", "at": "ACC-001.gas_port"}` | (1180,120)->(1170,190) |
