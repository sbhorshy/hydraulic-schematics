...
|---|---|---|---|---|
| 55 | `TANK-001.suction_out -> EMP-001.suction` | (318,686)->(538,710) | suction | 1 |
| 56 | `TANK-001.suction_out -> FSOV-001` | (318,686)->(368,330) | suction | 1 |
| 56 | `FSOV-001 -> EDP-001.suction` | (448,330)->(538,330) | suction | 1 |
| 60 | `EDP-001.pressure_out -> @PRESS` | (618,330)->(680,0) | pressure | 1 |
| 61 | `EMP-001.pressure_out -> @PRESS` | (618,710)->(680,0) | pressure | 1 |
| 62 | `@PRESS -> PF-001` | (680,0)->(1020,330) | pressure | 1 |
| 62 | `PF-001 -> @MANIFOLD` | (1100,330)->(1170,0) | pressure | 1 |
...
| 76 | `@PRESS -> PRV-002` | (680,0)->(578,871) | pressure | 1 |
| 76 | `PRV-002 -> TANK-001.bootstrap_pressure_in` | (438,871)->(272,840) | pressure | 1 |
| 77 | `@MANIFOLD -> QDP-001.inlet` | (1170,0)->(1188,474) | pressure | 1 |
...
| 90 | `@USERR -> RF-001` | (1636,0)->(1280,1020) | return | 1 |
| 90 | `RF-001 -> @RET` | (1200,1020)->(970,0) | return | 1 |
| 91 | `@RET -> TANK-001.return_in` | (970,0)->(100,686) | return | 1 |
| 92 | `@RET -> QDR-001.inlet` | (970,0)->(1000,934) | return | 1 |
| 96 | `EDP-001.case_drain -> @CASE` | (578,370)->(658,0) | case_drain | 1 |
| 97 | `EMP-001.case_drain -> @CASE` | (578,750)->(658,0) | case_drain | 1 |
| 98 | `@CASE -> CDF-001` | (658,0)->(500,217) | case_drain | 1 |
| 98 | `CDF-001 -> TANK-001.return_in` | (500,160)->(100,686) | case_drain | 1 |
