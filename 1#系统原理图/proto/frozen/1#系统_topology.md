...
|---|---|---|---|---|
| 48 | `TANK-001.suction_out -> EMP-001.suction` | (278,686)->(500,650) | suction | 1 |
| 49 | `TANK-001.suction_out -> FSOV-001` | (278,686)->(330,330) | suction | 1 |
| 49 | `FSOV-001 -> EDP-001.suction` | (410,330)->(500,330) | suction | 1 |
| 53 | `EDP-001.pressure_out -> @PRESS` | (580,330)->(880,0) | pressure | 1 |
| 54 | `EMP-001.pressure_out -> @PRESS` | (580,650)->(880,0) | pressure | 1 |
| 55 | `@PRESS -> PF-001` | (880,0)->(1000,338) | pressure | 1 |
| 55 | `PF-001 -> @MANIFOLD` | (1080,338)->(1160,0) | pressure | 1 |
...
| 61 | `@PRESS -> PRV-002` | (880,0)->(580,781) | pressure | 1 |
| 61 | `PRV-002 -> TANK-001.bootstrap_pressure_in` | (440,781)->(232,840) | pressure | 1 |
| 62 | `@MANIFOLD -> QDP-001.inlet` | (1160,0)->(1186,594) | pressure | 1 |
...
| 71 | `EDP-001.case_drain -> @CASE` | (540,370)->(620,0) | case_drain | 1 |
| 72 | `EMP-001.case_drain -> @CASE` | (540,690)->(620,0) | case_drain | 1 |
| 73 | `@CASE -> CDF-001` | (620,0)->(480,157) | case_drain | 1 |
...
| intent 行 | 语句 | 图上支路(端点) |
|---|---|---|
| 77 | `{"sensor": "ACV-001.accumulator_gas", "at": "ACC-001.gas_port"}` | (1240,90)->(1210,190) |
| 78 | `{"sensor": "PG-001.pressure_sense", "at": "ACV-001.charge_port"}` | (1446,117)->(1374,90) |
