...
| 90 | `RF-001 -> @RET` | (1200,1020)->(960,0) | return | 1 |
| 91 | `@RET -> TANK-001.return_in` | (960,0)->(100,686) | return | 1 |
| 92 | `@RET -> QDR-001.inlet` | (960,0)->(1000,934) | return | 1 |
...
| 98 | `CDF-001 -> TANK-001.return_in` | (480,160)->(100,686) | case_drain | 1 |
