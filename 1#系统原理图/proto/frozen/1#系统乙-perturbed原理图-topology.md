...
|---|---|---|---|---|
| 55 | `TANK-001.suction_out -> EMP-001.suction` | (278,686)->(538,750) | suction | 1 |
| 56 | `TANK-001.suction_out -> FSOV-001` | (278,686)->(368,330) | suction | 1 |
| 56 | `FSOV-001 -> EDP-001.suction` | (448,330)->(538,330) | suction | 1 |
| 60 | `EDP-001.pressure_out -> @PRESS` | (618,330)->(880,0) | pressure | 1 |
| 61 | `EMP-001.pressure_out -> @PRESS` | (618,750)->(880,0) | pressure | 1 |
| 62 | `@PRESS -> PF-001` | (880,0)->(1000,330) | pressure | 1 |
| 62 | `PF-001 -> @MANIFOLD` | (1080,330)->(1160,0) | pressure | 1 |
| 66 | `@MANIFOLD -> PRV-001` | (1160,0)->(1300,329) | pressure | 1 |
| 66 | `PRV-001 -> @USR` | (1440,329)->(1470,0) | pressure | 1 |
...
| 76 | `@PRESS -> PRV-002` | (880,0)->(578,891) | pressure | 1 |
| 76 | `PRV-002 -> TANK-001.bootstrap_pressure_in` | (438,891)->(232,840) | pressure | 1 |
| 77 | `@MANIFOLD -> QDP-001.inlet` | (1160,0)->(1188,594) | pressure | 1 |
...
| 97 | `EMP-001.case_drain -> @CASE` | (578,790)->(658,0) | case_drain | 1 |
| 98 | `@CASE -> CDF-001` | (658,0)->(480,157) | case_drain | 1 |
...
| intent 行 | 语句 | 图上支路(端点) |
|---|---|---|
| 102 | `{"sensor": "ACV-001.accumulator_gas", "at": "ACC-001.gas_port"}` | (1180,120)->(1210,190) |
| 103 | `{"sensor": "PG-001.pressure_sense", "at": "ACV-001.charge_port"}` | (1389,157)->(1314,120) |
